...
{
    //Campos opcionales en caso de que el Sistema Tercero no tenga IDs numericos, si no, Claves alfanumericas    
    protected String claveConceptoSistemaTercero;
    protected String claveAlmacenSistemaTercero;
    ...
    public String getClaveAlmacenSistemaTercero() {
        return claveAlmacenSistemaTercero;
    }

    public void setClaveAlmacenSistemaTercero(String claveAlmacenSistemaTercero) {
        this.claveAlmacenSistemaTercero = claveAlmacenSistemaTercero;
    }
