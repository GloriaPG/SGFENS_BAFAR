...
{
	/** 
	 * This attribute maps to the column ID_MARCA in the marca table.
	 */
	protected int idMarca;

	/** 
	 * This attribute maps to the column ID_EMPRESA in the marca table.
	 */
	protected int idEmpresa;

	/** 
	 * This attribute maps to the column ID_ESTATUS in the marca table.
	 */
	protected int idEstatus;

	/** 
	 * This attribute maps to the column NOMBRE in the marca table.
	 */
	protected String nombre;

	/** 
	 * This attribute maps to the column DESCRIPCION in the marca table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof Marca)) {
			return false;
		}
		
		final Marca _cast = (Marca) _other;
	...
	public String toString()
	{
		...
		ret.append( "com.tsp.sct.dao.dto.Marca: " );
