...
public class NominaTipoJornada implements Serializable
{
	/** 
	 * This attribute maps to the column ID_TIPO_JORNADA in the nomina_tipo_jornada table.
	 */
	protected int idTipoJornada;

	/** 
	 * This attribute represents whether the attribute idTipoJornada has been modified since being read from the database.
	 */
	protected boolean idTipoJornadaModified = false;

	/** 
	 * This attribute maps to the column ID_EMPRESA in the nomina_tipo_jornada table.
	 */
	...
	/** 
	 * This attribute maps to the column NOMBRE in the nomina_tipo_jornada table.
	 */
	...
	/** 
	 * This attribute maps to the column DESCRIPCION in the nomina_tipo_jornada table.
	 */
	...
	/** 
	 * This attribute maps to the column ID_ESTATUS in the nomina_tipo_jornada table.
	 */
	...
	/**
	 * Method 'NominaTipoJornada'
	 * 
	 */
	public NominaTipoJornada()
	{
	}

	/**
	 * Method 'getIdTipoJornada'
	 * 
	 * @return int
	 */
	...
	public void setIdTipoJornada(int idTipoJornada)
	{
		...
		this.idTipoJornadaModified = true;
	}

	/** 
	 * Sets the value of idTipoJornadaModified
	 */
	public void setIdTipoJornadaModified(boolean idTipoJornadaModified)
	{
		this.idTipoJornadaModified = idTipoJornadaModified;
	}

	/** 
	 * Gets the value of idTipoJornadaModified
	 */
	public boolean isIdTipoJornadaModified()
	{
		return idTipoJornadaModified;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof NominaTipoJornada)) {
			return false;
		}
		
		final NominaTipoJornada _cast = (NominaTipoJornada) _other;
		if (idTipoJornada != _cast.idTipoJornada) {
			return false;
		}
		
		if (idTipoJornadaModified != _cast.idTipoJornadaModified) {
			return false;
		}
	...
	public int hashCode()
	{
		...
		_hashCode = 29 * _hashCode + (idTipoJornadaModified ? 1 : 0);
	 ...
	 * Method 'createPk'
	 * 
	 * @return NominaTipoJornadaPk
	 */
	public NominaTipoJornadaPk createPk()
	{
		return new NominaTipoJornadaPk(idTipoJornada);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.tsp.sct.dao.dto.NominaTipoJornada: " );
