...
public class ComprobanteDescripcionCamposDaoImpl extends AbstractDAO implements ComprobanteDescripcionCamposDao
{
	/** 
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT ID_COMPROBANTE_DESCRIPCION, ID_CAMPO FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( ID_COMPROBANTE_DESCRIPCION, ID_CAMPO ) VALUES ( ?, ? )";
	...
	public void insert(ComprobanteDescripcionCampos dto) throws ComprobanteDescripcionCamposDaoException
	{
		...
		try {
			...
			_e.printStackTrace();
			throw new ComprobanteDescripcionCamposDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	/**
	 * Method 'ComprobanteDescripcionCamposDaoImpl'
	 * 
	 */
	public ComprobanteDescripcionCamposDaoImpl()
	{
	}
	 ...
	 * @param userConn
	 */
	public ComprobanteDescripcionCamposDaoImpl(final java.sql.Connection userConn)
	{
	...
	{
		return "COMPROBANTE_DESCRIPCION_CAMPOS";//"comprobante_descripcion_campos";
	}

	/** 
	 * Fetches a single row from the result set
	 */
	protected ComprobanteDescripcionCampos fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			ComprobanteDescripcionCampos dto = new ComprobanteDescripcionCampos();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected ComprobanteDescripcionCampos[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		ComprobanteDescripcionCampos ret[] = new ComprobanteDescripcionCampos[ resultList.size() ];
	 ...
	 */
	protected void populateDto(ComprobanteDescripcionCampos dto, ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void reset(ComprobanteDescripcionCampos dto)
	{
	}
