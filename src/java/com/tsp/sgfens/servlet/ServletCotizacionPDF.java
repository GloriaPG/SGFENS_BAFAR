 ...
 */
public class ServletCotizacionPDF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        SGCotizacionBO cotizacionBO = new SGCotizacionBO(idCotizacion,this.conn);        
        ...
        response.setHeader("Content-disposition",
                ...
                "Pretoriano_" + cotizacionBO.getCotizacion().getFolioCotizacion().replace(".xml", "").replace(".XML", "")
                + "_Cotizacion.pdf" );
    ...
    public String getServletInfo() {
        return "Servlet de apoyo para previsualizar PDF de Cotización.";
    }// </editor-fold>
}
