...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" 
	...
	<!--<xsl:include href="http://www.sat.gob.mx/sitio_internet/cfd/2/cadenaoriginal_2_0/utilerias.xslt"/>-->
        <xsl:include href="/xslt/v32/utilerias.xslt"/>
	<!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
        <!--DEL SITIO OFICIAL DEL SAT-->
        <!--
	...
	<xsl:include href="http://www.sat.gob.mx/sitio_internet/cfd/leyendasFiscales/leyendasFisc.xslt"/>
        -->
        <!--TERMINA DEL SITIO OFICIAL DEL SAT-->
        
        <!--DEL LOCAL (DESCARGADOS DEL SITIO OFICIAL SAT)-->
        <xsl:include href="/xslt/v32/complementos/ecc.xslt"/>
	<xsl:include href="/xslt/v32/complementos/psgecfd.xslt"/>
	<xsl:include href="/xslt/v32/complementos/donat11.xslt"/>
	<xsl:include href="/xslt/v32/complementos/divisas.xslt"/>
	<xsl:include href="/xslt/v32/complementos/ecb.xslt"/>
	<xsl:include href="/xslt/v32/complementos/detallista.xslt"/>
	<xsl:include href="/xslt/v32/complementos/implocal.xslt"/>
	<xsl:include href="/xslt/v32/complementos/terceros11.xslt"/>
	<xsl:include href="/xslt/v32/complementos/iedu.xslt"/>
	<xsl:include href="/xslt/v32/complementos/ventavehiculos.xslt"/>
	<xsl:include href="/xslt/v32/complementos/pfic.xslt"/>
	<xsl:include href="/xslt/v32/complementos/TuristaPasajeroExtranjero.xslt"/>
	<xsl:include href="/xslt/v32/complementos/leyendasFisc.xslt"/>
        <xsl:include href="/xslt/v32/complementos/nomina11.xslt"/>
        <!--TERMINA DEL LOCAL (DESCARGADOS DEL SITIO OFICIAL SAT)-->
