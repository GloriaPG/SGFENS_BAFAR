...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idCrFormularioValidacion = Integer.parseInt(request.getParameter("idCrFormularioValidacion")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     try{
         limiteRegistros = crFormularioValidacionBO.findCantidadCrFormularioValidacions(idCrFormularioValidacion, idEmpresa , 0, 0, filtroBusqueda);
        ...
        crFormularioValidacionDto = crFormularioValidacionBO.findCrFormularioValidacions(idCrFormularioValidacion, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catCrFormularioValidacion/catCrFormularioValidacion_form.jsp";
    String paramName = "idCrFormularioValidacion";
                ...
                <div class="inner">
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content" style="display: none;">
                            <form action="catCrFormularioValidacion_list.jsp" id="search_form_advance" name="search_form_advance" method="post">                                  
                                <p>
                    ...
                    <div class="onecolumn">
                        <div class="header">
                            <span>
                                ...
                                Catálogo de Validaciones para Formularios
                            </span>
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div id="search">
                                                <form action="catCrFormularioValidacion_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (CrFormularioValidacion item : crFormularioValidacionDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            <!--<td><input type="checkbox"/></td>-->
                                            <td><%= item.getIdFormularioValidacion() %></td>
                                            <td><%= StringManage.getValidString(item.getNombre()) %></td>
                                            <td><%= StringManage.getValidString(item.getDescripcion()) %></td>
                                            <td><%= StringManage.getValidString(item.getRegexJava()) %></td>
                                            <td>
                                                <% if (item.getIsCreadoSistema()==1){ %>
                                            ...
                                            <td>
                                                ...
                                                <%  if (item.getIsCreadoSistema()!=1){ %>
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdFormularioValidacion()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
                                                <%  } %>
                                                <%}%>
