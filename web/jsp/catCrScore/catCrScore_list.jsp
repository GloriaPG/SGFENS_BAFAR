...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    */
    ...
    try{
     ...
     try{
         limiteRegistros = crScoreBO.findCantidadCrScores(idCrScore, idEmpresa , 0, 0, filtroBusqueda);
        ...
        crScoreDto = crScoreBO.findCrScores(idCrScore, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catCrScore/catCrScore_form.jsp";
    String urlTo2 = "../catCrScoreDetalle/catCrScoreDetalle_list.jsp";
    String paramName = "idCrScore";
                ...
                <div class="inner">
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content" style="display: none;">
                            <form action="catCrScore_list.jsp" id="search_form_advance" name="search_form_advance" method="post">                                  
                                <p>
                    ...
                    <div class="onecolumn">
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div id="search">
                                                <form action="catCrScore_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                                    ...
                                    <tbody>
                                        ...
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdScore()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
                                                <a href="<%=urlTo2%>?<%=paramName%>=<%=item.getIdScore()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_crFormularioDisenar.png" alt="diseñar" class="help" title="Diseñar"/></a>
                                                &nbsp;&nbsp;
                                                <%}%>
                            ...
                            <jsp:include page="../include/reportExportOptions.jsp" flush="true">
                                <jsp:param name="idReport" value="<%= ReportBO.CR_SCORE_REPORT %>" />
