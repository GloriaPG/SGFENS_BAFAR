...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    int idMarca = -1;
    try{ idMarca = Integer.parseInt(request.getParameter("idMarca")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     Marca[] marcasDto = new Marca[0];
     try{
         limiteRegistros = marcaBO.findMarcas(idMarca, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        marcasDto = marcaBO.findMarcas(idMarca, idEmpresa,
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                            <tr>
                                                <td>
                                                    <div id="search">
                                                    <form action="catMarcas_list.jsp" id="search_form" name="search_form" method="get">
                                    ...
                                    <tbody>
                                        ...
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdMarca()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
                                                <%}%>
