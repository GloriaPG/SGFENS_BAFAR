<%-- 
    ...
    Created on : 09/06/2016, 12:55:48 PM
    Author     : ISCesar
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    try{ idCrFormulario = Integer.parseInt(request.getParameter("idCrFormulario")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     try{
         limiteRegistros = crFormularioBO.findCantidadCrFormularios(idCrFormulario, idEmpresa , 0, 0, filtroBusqueda);
        ...
        crFormularioDto = crFormularioBO.findCrFormularios(idCrFormulario, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catCrFormulario/catCrFormulario_form.jsp";
    String urlTo2 = "../catCrFormulario/catCrFormulario_disenar_form.jsp";
    String paramName = "idCrFormulario";
                ...
                <div class="inner">
                    ...
                    <div class="onecolumn">
                        ...
                        <div class="content" style="display: none;">
                            <form action="catCrFormulario_list.jsp" id="search_form_advance" name="search_form_advance" method="post">                                  
                                <p>
                    ...
                    <div class="onecolumn">
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div id="search">
                                                <form action="catCrFormulario_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                                ...
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            ...
                                            for (CrFormulario item : crFormularioDto){
                                                try{
                                                    String nombreGrupoFormulario = " - No asignado - ";
                                                    String nombreEmpleadoEdito = " - ";
                                                    try{
                                                        nombreGrupoFormulario = crGrupoFormularioBO.findCrGrupoFormulariobyId(item.getIdGrupoFormulario()).getNombre();
                                                    }catch(Exception ex){}
                                                    try{
                                        ...
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td><%= item.getIdFormulario()%></td>
                                            <td><%= nombreGrupoFormulario %></td>
                                            <td><%= item.getOrdenGrupo()>0 ? "" + item.getOrdenGrupo() : "?" %></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdFormulario()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
                                                <a href="<%=urlTo2%>?<%=paramName%>=<%=item.getIdFormulario()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_crFormularioDisenar.png" alt="diseñar" class="help" title="Diseñar"/></a>
                                                &nbsp;&nbsp;
                                                <%}%>
                            ...
                            <jsp:include page="../include/reportExportOptions.jsp" flush="true">
                                <jsp:param name="idReport" value="<%= ReportBO.CR_FORMULARIOS_REPORT %>" />
