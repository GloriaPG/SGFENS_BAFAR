<%-- 
    Document   : catImpuestos_list
    Created on : 28/11/2012, 12:01:41 PM
    Author     : Leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    int idImpuesto = -1;
    try{ idImpuesto = Integer.parseInt(request.getParameter("idImpuesto")); }catch(NumberFormatException e){}
    ...
    */
    ...
    try{
     ...
     Impuesto[] impuestosDto = new Impuesto[0];
     try{
         limiteRegistros = impuestoBO.findImpuestos(idImpuesto, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        impuestosDto = impuestoBO.findImpuestos(idImpuesto, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catImpuestos/catImpuestos_form.jsp";
    String paramName = "idImpuesto";
                    ...
                    <div class="onecolumn">
						...
						<tbody>
							<tr>
                                                            <td>
                                                                <div id="search">
                                                                <form action="catImpuestos_list.jsp" id="search_form" name="search_form" method="get">
                        ...
                        <div class="content">
                            <form id="form_data" name="form_data" action="" method="post">
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <% 
                                            for (Impuesto item:impuestosDto){
                                                try{
                                        %>
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>
                                            ...
                                            <td>
                                                ...
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdImpuesto()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                                                &nbsp;&nbsp;
